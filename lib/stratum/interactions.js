...
class ErrorAnswer {
    ...
    toJSON() {
        console.log('ErrorAnswer this.error.message is', this.error.message);
        console.log('ErrorAnswer this.error.code is', this.error.code);
        console.log('ErrorAnswer error is', this.error);
        return {
            error: {
