...
class Worker extends events.EventEmitter {
    ...
    async handleUpdate(updatedData) {
        ...
        try {
        if (updatedData){
            console.log('updatedData PASSED');
            if(this.subscribe){
            ...
            if(updatedData.challengeNumber !== '5'){
                console.log('updatedData.challengeNumber !== 5 true');
            }
            console.log('updatedData.challengeNumber !== 5 && this.authorized && this.subscribe', updatedData.challengeNumber !== '5' && this.authorized && this.subscribe);
            if (updatedData.challengeNumber !== '5' && this.authorized && this.subscribe) {
