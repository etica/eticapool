...
class Worker extends events.EventEmitter {
    ...
    sendNewJob(increaseJobId=true) {
        ...
        const randomxBlobRaw = this.convertToRawWithout0x(this.randomxBlob);
        const randomxSeedhashRaw = this.convertToRawWithout0x(this.randomxSeedhash);
              ...
              case 'submit':
                try{
                   // ------------  PoolSuspended   ------------  //
                     ...
                     const blockHeader = this.convertToRawWithout0x(this.randomxBlob);
                     ...
                     // Seed hash
                     const seedHash = this.convertToRawWithout0x(this.randomxSeedhash);
    ...
    convertWithout0x(_data){
        return _data.startsWith('0x') ? _data.slice(2) : _data;
    }

    convertToRawWithout0x(_data) {
