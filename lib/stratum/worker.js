...
class Worker extends events.EventEmitter {
    constructor(socket, poolConfig, poolStatsHelper, tokenDataHelper, mongoInterface) {
        ...
        this.randomxBlobWithReservedHash = randomxHelper.setReservedHashOnBlob(this.randomxBlob, this.poolAddress, this.challengeNumber, this.extraNonce);
    ...
    async handleUpdate(updatedContract) {
        ...
        if (updatedContract){
            if (updatedContract && updatedContract.challengeNumber !== this.challengeNumber && this.authorized && this.subscribe) {
                ...
                this.randomxBlobWithReservedHash = randomxHelper.setReservedHashOnBlob(this.randomxBlob, this.poolAddress, this.challengeNumber, this.extraNonce); // set specific miner blob by updating reservedSpace
