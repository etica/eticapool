...
class Worker extends events.EventEmitter {
    constructor(socket, poolConfig, poolStatsHelper, tokenDataHelper, mongoInterface) {
        ...
        this.jobId = 1;
        this.newShareExpectedTime = 160; // miners are expected to send new shares on average every 120 seconds
        this.lastShareSubmissionTime = 0;
        this.minShareSubmissionInterval = 6000; // 3 seconds in milliseconds
