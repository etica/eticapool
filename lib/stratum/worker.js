    ...
    /*
        convertTargetToCompact(target) {
            ...
            convertTargetToCompact(target) {
                ...
                const significand = targetBN.shrn(8 * (29 - msbyte)).maskn(24).toNumber();
                
                // Compose compact target
                const exponent = msbyte + 1;
       ...
       /* testCompactTargetConversion() {
            ...
            testCompactTargetConversion() {
                ...
                difficulties.forEach(difficulty => {
                    ...
                    const backCalculatedTarget = new web3utils.BN(significand).shln(8 * (exponent - 3));
