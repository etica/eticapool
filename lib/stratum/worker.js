...
class Worker extends events.EventEmitter {
    constructor(socket, poolConfig, poolStatsHelper, tokenDataHelper, mongoInterface) {
        ...
        this.jobId = 1;
        this.newShareExpectedTime = poolConfig.miningConfig.newShareExpectedTime || 180; // miners are expected to send new shares on average every 180 seconds
        this.lastShareSubmissionTime = 0;
        this.minShareSubmissionInterval = 3000; // 3 seconds in milliseconds
    ...
    async _processInteraction(interaction, poolStatsHelper, tokenDataHelper) {
        ...
        console.log('interaction.params is:', interaction.params);
        console.log('Interaction method:', typeof interaction.method, '"' + interaction.method + '"');
        console.log('Interaction method:', JSON.stringify(interaction.method));
        console.log('Interaction method length:', interaction.method.length);
        switch (interaction.method ? interaction.method.trim().toLowerCase() : '') {
            case 'login':
                ...
                //this.emit('subscribe');
                    ...
                    console.log('workerName is: ', workerName);
                    ...
                    if (!web3utils.isAddress(_minerEthAddress.toString())) {
                        ...
                        console.log('fullWorkerName is: ', this.fullWorkerName);
                ...
                try{
                   // ------------  Check not too many shares within  minShareSubmissionInterval to protect server resources ------------  //
                    ...
                    // check right randomxBlob //
                     ...
                     console.log('--- > worker calculatedHash is: ', calculatedHash.toString('hex'));
                    ...
                    console.log('--- > worker hashesMatch is: ', hashesMatch);
                    ...
                    console.log('--- > isClaimedTarget is: ', isClaimedTarget);
                    ...
                    console.log('-------- > NONCE VERIFIED WITH THE NEW CRYPTONIGHT PACKAGE < --------------');
                      ...
                      if(validJSONSubmit){
                        ...
                        default:
                            ...
                            console.log('unknown interaction.method is:', interaction.method);
                            console.log('typeof unknown interaction.method is: ', typeof interaction.method);
    ...
    async setMinerSpecificTarget() {
        ...
        if (minerData && minerData.avgHashrate && minerData.avgHashrate > 0) {
            ...
            console.log('newShareExpectedTime is: ', this.newShareExpectedTime);
