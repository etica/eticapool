        ...
        switch (interaction.method) {
            case 'login':
                ...
                //this.emit('subscribe');
                    ...
                    if (!web3utils.isAddress(minerLogin.toString())) {
                ...
                break;
            case 'job':
                    const blob = interaction.params.blob;
                    const target = interaction.params.target;
                    const job_id = interaction.params.job_id;
