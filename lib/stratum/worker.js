...
class Worker extends events.EventEmitter {
    constructor(socket, poolConfig, poolStatsHelper, tokenDataHelper, mongoInterface) {
        ...
        this.minShareSubmissionInterval = 200; // 200 milliseconds
    ...
    async setMinerNameDetails(_fullWorkerName, _addressBlockchain, _workerName) {
        ...
        console.log('setting miner Names Details');
        console.log('setting miner Names Details _fullWorkerName', _fullWorkerName);
        console.log('setting miner Names Details _addressBlockchain', _addressBlockchain);
        console.log('setting miner Names Details _workerName', _workerName);
                ...
                console.log('minerData retrieved is:', minerData);
                

                if (!minerData) {
                    console.log('Miner data not found');
                    return;
                }

                if (!web3utils.isAddress(_addressBlockchain.toString())) {
                    console.log('Invalid blockchain address');
                    return;
                } 
                ...
                if(!minerData.addressBlockchain || (_workerName && !minerData.workerName)){
                    ...
                    if (_workerName){
                        console.log('_workerName true:', _workerName);    
                    }
                    else {
                        console.log('_workerName false:', _workerName);
                    }
                    console.log('_workerName is:', _workerName);
                    console.log('!minerData.workerName is:', !minerData.workerName);

                if (_workerName && !minerData.workerName) {
                    console.log('setting miner Names Details case I');
                    ...
                    console.log('setting miner Names Details case II');
                    await this.mongoInterface.updateOne(
                        'minerData',
                        { minerEthAddress: _fullWorkerNameFormatted },
