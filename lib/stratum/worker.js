...
class Worker extends events.EventEmitter {
    constructor(socket, poolConfig, poolStatsHelper, tokenDataHelper) {
        ...
        this._socket = socket;
        this.chain = 'bsc' // default to BNBTC
        ...
        switch (interaction.method) {
            ...
            case 'authorize':
                ...
                if (!this.subscribe) {
                    ...
                    this.poolSuspended = (poolStatsHelper && poolStatsHelper.poolStatus && poolStatsHelper.poolStatus[this.chain] && poolStatsHelper.poolStatus[this.chain].poolStatus !== "active")
