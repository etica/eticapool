...
class Worker extends events.EventEmitter {
    ...
    setReservedHash(blockHeader){
        ...
        console.log('extraNonce is: ', this.extraNonce);
        const extraNonce0xFormat = "0x"+ this.extraNonce;

        console.log('this.poolAddress is:', this.poolAddress);
        console.log('this.challengeNumber is:', this.challengeNumber);
        console.log('extraNonce0xFormat is:', extraNonce0xFormat);

        console.log('typeof this.poolAddress is:', typeof this.poolAddress);
        console.log('typeof this.challengeNumber is:', typeof this.challengeNumber);
        console.log('typeof extraNonce0xFormat is:', typeof extraNonce0xFormat);

        var poolHash = web3utils.soliditySha3(this.poolAddress);
        console.log('poolHash is:', poolHash);

        var challengeNumberHash = web3utils.soliditySha3(this.challengeNumber);
        console.log('challengeNumberHash is:', challengeNumberHash);

        var extraNonce0xFormatHash = web3utils.soliditySha3(extraNonce0xFormat);
        console.log('extraNonce0xFormatHash is:', extraNonce0xFormatHash);


        var extraNonceHash = web3utils.soliditySha3( this.poolAddress, extraNonce0xFormat, this.challengeNumber );
