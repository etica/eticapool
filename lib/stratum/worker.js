              ...
              case 'submitShare':
                try{
                   ...
                   //let poolSuspended = await PoolStatsHelper.poolMintingIsSuspended(poolConfig,mongoInterface)
                      ...
                      var diggest = interaction.params[2].toString()
                    ...
                    // ------- PoolSuspended -------- //
                      ...
                      var poolEthAddress_I2 = PeerHelper.getPoolEthAddress(poolConfig) ; // cannot re use var name poolEthAddress so named it poolEthAddress_I2 (for Instance 2)
