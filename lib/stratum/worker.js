...
class Worker extends events.EventEmitter {
    ...
    async setMinerNameDetails(_fullWorkerName, _addressBlockchain, _workerName) {
        ...
        console.log('setting miner Names Details _workerName', _workerName);
                ...
                const minerData = await PeerHelper.getMinerData(_fullWorkerName.toString().toLowerCase(), this.mongoInterface);
                ...
                if (_workerName && !minerData.workerName) {
                    minerData.workerName = _workerName;
                    await this.mongoInterface.updateOne(
                        'minerData',
                        { _id: minerData._id },
                        { $set: { addressBlockchain: minerData.addressBlockchain, workerName: minerData.workerName } }
                    );
                }
                else{
                    await this.mongoInterface.updateOne(
                        'minerData',
                        { _id: minerData._id },
                        { $set: { addressBlockchain: minerData.addressBlockchain } }
                    );
                }
