    ...
    async setMinerSpecificTarget() {
        ...
        if (minerData && minerData.avgHashrate && minerData.avgHashrate > 0) {
            ...
            if (this.entryPort == 3333) {
               minimumDifficulty = 50000;
            } else if (this.entryPort == 5555) {
               minimumDifficulty = 150000;
            } else if (this.entryPort == 7777) {
               minimumDifficulty = 250000;
            } else {
               minimumDifficulty = this.poolConfig.minimumTarget.toString();
            }
            ...
            this.difficulty = this.safeBigNumberToNumber(calculatedDifficulty);
