...
export default class StatsInterface {
  ...
  async init(){
    ...
    await this.calculate_current_stats_payment() 
  ...
  async  update()
  {
    ...
    setInterval(function(){ StatsInterface.calculate_current_stats_payment(this.mongoInterface,this.poolConfig)}.bind(this) , 3600*1000) // Every hour
  
  } 


  // Payments stats:
  async calculate_current_stats_payment()
    { 
