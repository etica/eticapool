...
export default class StatsInterface {
  ...
  async init(){
    ...
    await this.CalculateCurrentStatsPayment(this.mongoInterface,this.poolConfig).bind(this);
  ...
  async  update()
  {
    ...
    setInterval(function(){ TokenInterface.CalculateCurrentStatsPayment(this.mongoInterface,this.poolConfig)}.bind(this) , 20*1000) // Every hour
