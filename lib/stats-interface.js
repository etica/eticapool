...
export default class StatsInterface {
  ...
  async init(){
    ...
    await this.calculate_current_stats_payment(this.mongoInterface,this.poolConfig).bind(this);
  ...
  async  update()
  {
    ...
    setInterval(function(){ TokenInterface.calculate_current_stats_payment(this.mongoInterface,this.poolConfig)}.bind(this) , 20*1000) // Every hour
    
  } 


  // Payments stats:
  async calculate_current_stats_payment(mongoInterface, poolConfig)
    { 
