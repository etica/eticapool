...
export default class TokenInterface {
 ...
 static async queueMiningSolution(solution_number,minerEthAddress,challenge_digest,challenge_number, randomx_blob, randomx_seedhash, randomxhash, claimedtarget, mongoInterface, poolConfig)
  {
