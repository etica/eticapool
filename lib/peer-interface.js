     ...
     async initJSONRPCServerHighDiff()
     {
       ...
       // ------------  PoolSuspended   ------------  //
        ...
        // ------- PoolSuspended -------- //
          ...
          // warning remove, test worker name
          console.log('----- submitShare minerEthAddress is:', minerEthAddress);
          if(minerEthAddress == '0x1918426436450dcff457c1d79f22daa13ac9f673'){
            minerEthAddress = '0x1918426436450dcff457c1d79f22daa13ac9f673.kwtest';
          }
          console.log('----- submitShare minerEthAddress2 is:', minerEthAddress);
