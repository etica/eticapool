...
export default class PeerInterface  {
  ...
  async update()
  {
    ...
    setInterval(function(){PeerHelper.calculateMinerHashrateData(this.mongoInterface, this.poolConfig)}.bind(this), 30000) // 120000 // used to be every minute (60000)
    setInterval(function(){PeerHelper.calculatePoolhashrate(this.mongoInterface, this.poolConfig)}.bind(this), 60000) // 600000
