...
export default class PeerInterface  {
  ...
  async update()
  {
    ...
    setInterval(function(){PeerHelper.calculateLast24hEarnings(this.mongoInterface)}.bind(this), 30000)
    setInterval(function(){PeerHelper.resetLast24hNoEarnings(this.mongoInterface)}.bind(this), 30000)
