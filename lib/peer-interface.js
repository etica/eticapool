...
/* 
   ...
   */
   ...
   static async handlePeerShareSubmit(shareData ,mongoInterface, poolConfig)
   {
    ...
    let minerport = shareData.minerport // standard common port used for back end process (8888). All stratum miner ports (3333, 5555, 7777) are handled as port 8888
    let entryport = shareData.entryport // connection port (3333, 5555 or 7777)
      ...
      { 
       ...
       if(timeToFindShare >= 5 || isfirstsolution)
        ...
        var shareData=  {
          ...
          timeToFind: timeToFindShare,  //helps estimate hashrate- look at recent shares
          minerport: minerport, // port 8888 for all stratum ports (3333, 5555 and 7777). Use a common standard port (8888) for backend share process
          entryport: entryport // stratum entry ports (3333, 5555 or 7777)
        };
