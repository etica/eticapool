...
/* 
   ...
   */
   ...
   static async handlePeerShareSubmit(shareData ,mongoInterface, poolConfig)
   {
    ...
    console.log('--- > blobWithNonce is: ', blobWithNonce);

     const calculatedHash = multiHashing.randomx(newVerifyminerBlob, Buffer.from(seedHash, 'hex'), 0);

     console.log('--- > calculatedHash is: ', calculatedHash);
     console.log('--- > typeof calculatedHash is: ', typeof calculatedHash);
