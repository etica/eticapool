...
// Note: String objects don't have a toBuffer() method, so we'll use Buffer.from() instead
const randomxhashBNtest1 = Buffer.from(randomxhashBNString, 'hex');
console.log('randomxhashBNtest1 is: ', randomxhashBNtest1.toString('hex'));

const randomxhashBNtest2 = Buffer.from(randomxhashBNString, 'hex').reverse();
console.log('randomxhashBNtest2 is: ', randomxhashBNtest2.toString('hex'));

// Note: BN objects don't have a toBuffer() method directly, so we'll convert to hex first
const randomxhashBNtest3 = Buffer.from(randomxhashBN.toString(16), 'hex');
console.log('randomxhashBNtest3 is: ', randomxhashBNtest3.toString('hex'));

const randomxhashBNtest4 = Buffer.from(randomxhashBN.toString(16), 'hex').reverse();
console.log('randomxhashBNtest4 is: ', randomxhashBNtest4.toString('hex'));
