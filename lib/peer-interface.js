...
export default class PeerInterface  {
  ...
  async processQueuedShares(mongoInterface, poolConfig)
  {
    ...
    // If a share was found, check immediately for more. Otherwise wait 500ms before polling again.
    var pollDelay = shareFound ? 0 : 500;
    setTimeout(function(){this.processQueuedShares(mongoInterface,poolConfig)}.bind(this), pollDelay)
