    ...
    export default class APIHelper  {
        ...
        static async getNetworkDailyMetrics(request, poolConfig, mongoInterface){
         ...
         static async getHashrateMiner(request, mongoInterface){
             console.log('getHashrateMiner api request', request.params );
             const minerEthAddress = request.params['minerEthAddress'];
             console.log('getHashrateMiner minerEthAddress api request is: ', minerEthAddress);

             if(minerEthAddress && web3utils.isAddress(minerEthAddress)){
