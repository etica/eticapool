  ...
  static async getMinerDataWithWorkers(minerEthAddress, mongoInterface)
  {
    ...
    if(minerEthAddress)
    {
      ...
      if(minerData  == null)
      {
        ...
        // Fetch workers data
        const workersData = await mongoInterface.findAllSortedWithLimitonString('minerData', {addressBlockchain: addressBlockchain.toLowerCase(), workerName: { $exists: true, $ne: null }}, {workerName:1}, 1000);

        console.log(' workersData for Profile page is:', workersData);
        ...
        if(workersData && workersData.length > 0){
            ...
            minerData.workers = workersData.map(worker => {
                ...
                totalTokensEarned += worker.tokensAwarded || 0;
        ...
        minerData.totalTokensEarned += minerData.tokensAwarded + totalTokensEarned;
        ...
        console.log(' minerData for Profile page is:', minerData);
