...
static async calculateLast24hEarnings(mongoInterface) {
  try {
    ...
    // Aggregate tokens awarded in the last 24 hours for each miner
    const earnings = await mongoInterface.aggregateOnCollection('ppnls_rewards', [
    ...
    console.log('earnings are:', earnings);
