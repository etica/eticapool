      ...
      if(minerData  == null)
      {
        ...
        if(workersData && workersData.length > 0){
            ...
            minerData.workers = workersData.map(worker => {
                ...
                totalTokenBalance += worker.tokenBalance || 0;
            ...
            minerData.totalAvgHashrate = totalAvgHashrate;
            minerData.totalTokensEarned = totalTokensEarned;
            minerData.totalTokensReceived = totalTokensReceived;
            minerData.totalTokenBalance = totalTokenBalance;
            minerData.totalAlltimeTokenBalance = totalAlltimeTokenBalance;
