...
static async calculateNetworkhashrate(mongoInterface, poolConfig) {
  ...
  console.log('poolHashrate[0]', poolHashrate[0])
  console.log('poolNumberminers[0]', poolNumberminers[0])

  if(poolHashrate && poolHashrate[0] && !isNaN(poolHashrate[0].Hashrate)){
    console.log('poolHashrate[0].Hashrate', poolHashrate[0].Hashrate)
       networkHashrate = poolHashrate[0].Hashrate;
  }

  if(poolNumberminers && poolNumberminers[0] && !isNaN(poolNumberminers[0].Numberminers)){
    console.log('poolNumberminers[0].Numberminers', poolNumberminers[0].Numberminers)
       networkNumberminers = poolNumberminers[0].Numberminers;
  } 

  console.log('pool -> networkHashrate', networkHashrate)
  console.log('pool -> networkNumberminers', networkNumberminers)
