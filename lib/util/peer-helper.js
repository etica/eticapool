...
static async calculateLast24hEarnings(mongoInterface) {
  try {
    ...
    const LastEarningsSum = await PeerHelper.getLastEarningsSum2(mongoInterface, (PeerHelper.getTimeNowSeconds() - EarningsCalculationPeriod))
...
static async getLastEarningsSum2(mongoInterface, unixTime) {
  console.log('calling getLastEarningsSum2');
  ...
  console.log('minerEarningsSum2 is:', minerEarningsSum);
