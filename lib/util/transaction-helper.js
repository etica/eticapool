...
export default class TransactionHelper  {
  ...
  static async submitMiningSolution(minerAddress,solution_number, challenge_number, randomx_blob, randomx_seedhash, randomxhash, claimedtarget, mongoInterface,poolConfig){
   ...
   var mintMethod = tokenContract.methods.mintrandomX( solution_number, randomx_blob, challenge_number, randomxhash, claimedtarget, randomx_seedhash )
  ...
  try{
   ...
   console.log('-challege_number:', challenge_number);
    ...
    solution_number = randomxHelper.convertAdd0x(solution_number);

    console.log('-nonce with 0x:', solution_number);
    ...
    var txData = web3.eth.abi.encodeFunctionCall({
        ...
        }, [solution_number, randomx_blob, challenge_number, randomxhash, claimedtarget, randomx_seedhash ]);
