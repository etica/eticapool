...
export default class TokenDataHelper {
  ...
  static async collectTokenParameters(tokenContract, web3,  mongoInterface  )
  {
    ...
    let testMiningContractData = {
      challengeNumber: '0x2722aec4209d4bc1ffd1084eddb2336a4c1ed77050dfcdeb629ebb4bb4779bfe',
      epochCount: 8455 // added field epochCount, used by PeerInterface -> rewardCrawl() to query
    }
    GeneralEventEmitterHandler.getInstance().emit('newChallenge', testMiningContractData);
