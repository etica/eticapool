...
async CheckChallengeNumberForWorkers(){
  ...
  console.log('TokenDataHelper');
  TokenDataHelper.on('newChallenge', async function (miningContractData) { 

    console.log('new challenge number detected!, new miningContractData: ', miningContractData);
