          ...
          async startSratumServer(){
            ...
            portConfigs.forEach(config => {
              ...
              const stratumserver = net.createServer(async (socket) => {
                ...
                if (!ipAddress) {
                  console.log('Rejected UNDEFINIED  ----------------- > undefined IP <-------------- ');
                  console.log('Rejected undefined IP');
              ...
              try {
                ...
                socket.once("data", (data) => {
                  ...
                  try {
                    ...
                    .then((rateLimiterRes) => {
                      console.log(`RATELLIMIT PASSED`);
                      console.log(`RATELLIMIT PASSED with rateLimiterRes ${rateLimiterRes}`);
                      // 2 points consumed
                    ...
                    .catch((rateLimiterRes) => {
                      ...
                      console.log(`RATELLIMIT NOT PASSED`);
                      console.log(`RATELLIMIT NOT PASSED with rateLimiterRes ${rateLimiterRes}`);
