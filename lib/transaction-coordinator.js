     ...
     console.log('miners_challengediffs', miners_challengediffs);
      if( miners_challengediffs ){
        ...
        if( miners_challengediffs){
            ...
            let param2 = onepoolmint.epochCount - (PPNLSDEPTH + 1);
            ...
            if (_miningContractsData.length > PPNLSDEPTH) {
            ...
            for(let oneminer_challengetotaldiff of  miners_challengediffs){
               ...
               await PeerInterface.processAddressforChallenge( oneminer_challengetotaldiff, ppnls_challenge_numbers, pplns_totalDifficulties_BN, onepoolmint, mongoInterface, poolConfig );
            }
    }
