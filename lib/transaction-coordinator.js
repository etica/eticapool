   ...
   */
   ...
   if(txType=="solution"){
    ...
    if( currentchallengenumber == txData.challenge_number){
          ...
          var submitResult =    await TransactionHelper.submitMiningSolution(txData.minerEthAddress,txData.solution_number, txData.challenge_number, txData.randomx_blob, txData.randomx_seedhash, txData.randomxhash, txData.claimedtarget, mongoInterface, poolConfig)
