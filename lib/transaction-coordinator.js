   ...
   async rewardCrawl( mongoInterface, poolConfig )
   {
    ...
    for(let onepoolmint of unprocessedPoolmints)
    {
     ...
     if(_miningContractData && _miningContractData != null){
            ...
            console.log('pplnschallenge numbers: ', pplns_challenge_numbers);

     // find all miners of this pplns round:
     var miners_pplns = await mongoInterface.findAll('miner_challengediff', {challengeNumber: { $in: pplns_challenge_numbers },status: 1});

     console.log('miners_pplns: ', miners_pplns);
     ...
     for(let oneminerAddress of uniqueMiners){
      ...
      console.log('oneminerAddress: ', oneminerAddress);
      ...
      console.log('inserting missing newminerchallengediff', newminerchallengediff);
     ...
     console.log('inserting missing miners_challengediffs', miners_challengediffs);
