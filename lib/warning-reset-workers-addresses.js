...
export default class ResetWorkersAddresses  {
  ...
  async ResetWorkersBalances(mongoInterface) {
      ...
      console.log('------------------------------------------------------------------------------------------------------');
      console.log('------------ Total pool unpaid amount (includes addresses with or without worker names) is: ', rawAmountToFormattedAll, 'ETI');
      console.log('------------ Unpaid amount to addresses using worker names is: ', rawAmountToFormatted, 'ETI');
      console.log('------------------------------------------------------------------------------------------------------');
      console.log('---------- Check your pool has enough liquidity to honour the amount of ', rawAmountToFormatted, 'ETI');
      console.log('---------- If confirm next step to reset balance of addresses that used worker names ---------');
