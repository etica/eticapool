...
var INFURA_ROPSTEN_URL = process.env.INFURA_ROPSTEN_URL || 'https://ropsten.infura.io/v3/YOUR_INFURA_KEY';
var INFURA_MAINNET_URL = process.env.INFURA_MAINNET_URL || 'https://mainnet.infura.io/v3/YOUR_INFURA_KEY';
  ...
  describe('Balance Payments', function() {
    it('can batch payments  ', async function() {
      ...
      for(var i=0;i<NUM_PAYMENTS;i++)
      {
        ...
        var upsert = await mongoInterface.upsertOne('balance_payments',{id: balancePaymentData.id},  balancePaymentData  )
        assert.ok(upsert) ;
      ...
      var unbatched_pmnts = await mongoInterface.findAll('balance_payments',{batchId: undefined})
