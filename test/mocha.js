...
//const TokenContractJSON = require("./assets/contracts/build/EticaRelease.json")

const TokenContractJSON = FileUtils.readJsonFileSync('/test/assets/contracts/build/EticaRelease.json');
